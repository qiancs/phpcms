...
?>
    <div class="col-auto">
            ...
            <div class="content">
                <table cellpadding="0" width="100%" class="table-list">
                    ...
                    <tr>
                        ...
                        <td><a href="?m=invest&c=congress&a=modify&id=<?php echo $val['id'];?>">修改</a> </td>
                        <td><a href="?m=invest&c=congress&a=delete&id=<?php echo $val['id'];?>" onclick="if (!confirm('确认要删除？')) window.event.returnValue = false; ">删除</a> </td>
                    </tr>
                    <?php $n++;}unset($n); ?>
        ...
        <div class="col-lg-1">
            <button class="button" onclick="location.href='?m=invest&c=congress&a=add&type=3'">添加终止资格人大代表</button>
            <button class="button" onclick="location.href='?m=invest&c=congress&a=add&type=4'">添加暂停职务人大代表</button>
            <button class="button" onclick="location.href='?m=invest&c=congress&a=add&type=5'">添加违纪当选人大代表</button>
