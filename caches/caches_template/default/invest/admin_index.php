...
?>
    <div class="col-auto">
        <div class="col-1">
            ...
            <div class="content">
                <table cellpadding="0" width="100%" class="table-list">
                    ...
                    <tr>
                        <td ><a href="?m=invest&c=admin&a=show&id=<?php echo $val['id'];?>"><?php echo $val["name"];?></a> </td>
                        <td><?php echo $val["office"];?></td>
                        <td><?php echo translate_invest_type($val["type"]);?></td>
                        <td><?php echo $val["organization"];?></td>
                        <td><a href="?m=invest&c=admin&a=modify&id=<?php echo $val['id'];?>">修改</a> </td>
                        <td><a href="?m=invest&c=admin&a=delete&id=<?php echo $val['id'];?>" onclick="if (!confirm('确认要删除？')) window.event.returnValue = false; ">删除</a> </td>
                    </tr>
                    <?php $n++;}unset($n); ?>
        ...
        <div class="col-lg-1">
            <button class="button" onclick="location.href='?m=invest&c=admin&a=add&type=10'">添加受行政处罚的党员</button>
        </div>
    </div>
</div>
