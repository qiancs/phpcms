...
<table width="100%" cellspacing="0"  class="table-list">
	...
	<td  width="35%" align=""><a href="<?php echo APP_PATH;?>index.php?m=message&c=index&a=read_only&messageid=<?php echo $info['messageid'];?>"><?php echo $info['subject'];?></a></td>
	<td width="8%" align="center"><?php echo $info['payment'];?></td>
	<td width="15%" align="center"><?php echo $info['send_to_id'];?></td>
