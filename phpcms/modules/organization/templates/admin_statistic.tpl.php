...
<div class="content">
    ...
    <form id="organizationform" action="" method="post">
        ...
        <table class="table table-bordered" style="width:100%;">
            ...
            <tr>
                <th colspan="2" >涉及“黄赌毒”等行政处罚案件，应当追究党纪责任的党员人数</th>
            ...
            <tr>
                ...
                <td><?php echo $row[solve1] ?></td>
            </tr>
            <tr>
                <th>组织处理</th>
                <td><?php echo $row[solve2] ?></td>
            </tr>
            <tr>
                <th rowspan="2">清理前未按规定给予党纪处分和组织处理情况</th>
                <th>党纪处分</th>
                <td><?php echo $row[solveless1] ?></td>
            </tr>
            <tr>
                <th>组织处理</th>
                <td><?php echo $row[solveless2] ?></td>
            </tr>
            <tr>
